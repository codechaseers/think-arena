...
import { Brain, Users, Timer, Trophy, Navigation } from "lucide-react";
      ...
      <div className="py-20 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl text-blue-900/80 mb-8">
            Challenge players worldwide in this fast-paced multiplayer quiz
            game. Create rooms, join battles, and prove your expertise!
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            {[
              ...
              <div
                key={index}
                className="p-4 rounded-xl bg-white/80 shadow-lg shadow-blue-100/50 border border-blue-100"
              >
